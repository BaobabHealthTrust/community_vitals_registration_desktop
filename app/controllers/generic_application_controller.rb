class GenericApplicationController < ActionController::Base
  ...
  def print_and_redirect(print_url, redirect_url, message = "Chonde dikilani...", show_next_button = false, patient_id = nil)
    @print_url = print_url
  ...
  def print_location_and_redirect(print_url, redirect_url, message = "Chonde dikilani...", show_next_button = false, patient_id = nil)
    @print_url = print_url
    @redirect_url = redirect_url
    @message = message
    @show_next_button = show_next_button
