Community Vitals Registration is a simple web application for registering people in a community.It is written in Ruby on Rails with OpenMRS® Data Model.
